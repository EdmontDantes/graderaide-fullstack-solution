...
const newStudentTile = function() {
    ...
    <input type="text" name="new-grade-assignment" class="new-grade-assignment" id="assignment${numId.length}" placeholder="Assignment Name">
    <button type="submit" class="submit-new-grade-assignment" id="grade-input${numId.length}">Submit</button>`
...
const createFromInputGrades = function(event) {
    ...
    const newGradeQueryInternal = document.querySelector(`.new-grade #${id}`);
