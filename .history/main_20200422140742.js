...
const newStudentTile = function() {
    ...
    studentDisplay.innerHTML = `<input type="text" name="new-grade" class="new-grade" placeholder="New Grade">`
    studentDisplay.innerHTML = `<input type="text" name="new-grade-assignment" class="new-grade-assignment" placeholder="Assignment Name">`
}
