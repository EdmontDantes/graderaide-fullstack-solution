...
const newStudentTile = function() {
    ...
    <button type="submit" class="submit-new-grade-assignment" id="new-grade-input${numId.length}">Submit</button>
    let submitGradeButton = addGradesSection.append('button')
