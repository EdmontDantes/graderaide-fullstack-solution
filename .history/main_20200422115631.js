...
const btnShowHideAddInputQuery = document.querySelector('#show-hide-add-input')

const dataGradesInputQuery = document.querySelector('#data-grades-input')
const btnShowHideAddInputFunc = () => {
    dataGradesInputQuery.style.display = 'hidden';
}

btnShowHideAddInputQuery.addEventListener('click', btnShowHideAddInputFunc)