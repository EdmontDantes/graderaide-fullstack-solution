...
const newStudentNameQuery = document.querySelector('#new-student-name-input-box');
const newStudentCourseNameQuery = document.querySelector('new-student-course-input-box');
const newStudentTermNumOptionQuery = document.querySelector()
const btnNewStudentQuery = document.querySelector('.new-student-button');

const newStudentTile = (Name, Course) => {
    newStudentNameQuery.value = Name;
    newStudentCourseNameQuery.value = Course;
