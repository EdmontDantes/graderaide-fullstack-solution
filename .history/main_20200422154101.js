...
const newStudentTile = function() {
    ...
    <input type="text" name="new-grade" class="new-grade" placeholder="New Grade">
    <input type="text" name="new-grade-assignment" class="new-grade-assignment" placeholder="Assignment Name">
    ...
    const newGradeAssignment = document.querySelector('.new-grade-assignment')
    const btnSubmitNewGradePlusAssigmentToCurrentStudent = document.querySelector('.submit-new-grade-assignment')

    grade = newGradeQueryInternal
}

btnNewStudentSubmitQuery.addEventListener('click', newStudentTile);


const addGradeWithAssignment = function() {
